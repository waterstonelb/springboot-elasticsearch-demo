package com.example.es_test.util;
...
public class EsUtil {
  ...
  private final String DEDAULT_TYPE="prophet";


  /**
   * 创建索引
   * @param indexName 索引名
   * @param settings index创建配置（json/yml）文件
   * @param mapping
   ...
   * @return
   */
  public GetResponse searchByIndexAndId(String indexName,String id) throws IOException {
    GetRequest getRequest = new GetRequest("bank",DEDAULT_TYPE,id);
